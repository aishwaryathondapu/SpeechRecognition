...
class SR_GUI(Frame):
    ...
    def __init__(self, master):
        ...
        #self.photo = PhotoImage('sau logo.png')
        master.iconbitmap('mul_logo.ico')
        self.add_widgets()
    ...
    def add_widgets(self):
        ...
        self.combo_speech.bind("<Return>", self.onkey_release)
        ...
        self.labelframe_widget = Label(self.master, text="Translation", bg="#D95137", font="none 10 bold")
        self.labelframe_widget.place(x=5, y=350)
        ...
        self.lang_values_Capitalize.sort()
        ...
        self.combo_widget1.bind("<Return>", self.translation_key_release)
        ...
        self.yes_radiobutton = Radiobutton(self.labelframe_widget, text="Yes", variable=var, value=1, bg="#00529B",
                                           state=DISABLED)
        self.yes_radiobutton.place(x=5, y=60)
        self.no_radiobutton = Radiobutton(self.labelframe_widget, text="No", variable=var, value=2, bg="#00529B",
                                          state=DISABLED)
        ...
        self.label_combo = Label(self.master, text="Translation Language:", bg="#D95137")
    ...
    def onkey_release(self,event):
        ...
        print(value)
        if value == '':
            data = self.speech_lang_values
        else:
            data = []
            for item in self.speech_lang_values:
    ...
    def listbox_update(self,data):
        ...
        self.combo_speech.delete(0, 'end')
        # sorting data
        data = sorted(data, key=str.lower)
        self.combo_speech.configure(values=data)
        self.combo_speech.set(data[0])
    ...
    def translation_key_release(self,event):
        value = event.widget.get().lower()
        self.lang_values = list(languages.values())
        self.lang_values.sort()
        self.lang_values_Capitalize = [self.lang_value.capitalize() for self.lang_value in self.lang_values]
        print(value)
        if value == '':
            data = self.lang_values_Capitalize
        else:
            data = []
            for item in self.lang_values_Capitalize:
                if item.lower().startswith(value):
                    print(item)
                    data.append(item)
            print(data)
        self.translationbox_update(data)

    def translationbox_update(self,data):
        # delete previous data
        self.combo_widget1.delete(0, 'end')
        # sorting data
        data = sorted(data, key=str.lower)
        self.combo_widget1.configure(values=data)
        self.combo_widget1.set(data[0])
